...
| Degrau | "1 · Índice", "2 · Desempenho", "3 · Página certa para o termo", "4 · Posição", "5 · Snippet" | etapa, fase, prioridade, nível | bloco "O que fazer primeiro" (054) — a ordem de ataque; o número é a ordem. Desde a 055 os cinco aparecem sempre; o vazio diz "sem ação · …" com a contagem das folhas |
| Sem disparo | "<n> sem disparo", "nenhuma das <n> folhas disparou" | dentro, ok, aprovado, ✓ | linha do degrau vazio (055) — a regra da folha não pediu trabalho; não é veredito |
| Marcar como feito | legenda do form na entrada, com "reler em" e um botão por responsável | concluir, fechar, resolver, check | entrada do bloco "O que fazer primeiro" (055) — marca a alavanca no projeto; não muda leitura, regra nem folha |
| Aguardando | "Aguardando · feito em <dd/mm> por <nome> · reler em <dd/mm>"; "· aguardando" no degrau todo marcado | concluído, resolvido, ✓, ok | entrada marcada no prazo (055) — o trabalho da casa foi feito, o resultado depende do Google |
