...
export const PERFIS = {
  ...
  D: {
    ...
    marcos: [
      ...
      { chave: "contatado", nome: "contato feito", coletor: null, familia: "D4", fonte: "histórico de status do lead — `status` é posição ATUAL, não evento: quem cancelou depois de atendido já não conta como contatado" },
