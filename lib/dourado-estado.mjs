...
//
// A quarta família não estava na spec e nasceu da leitura dos 35: sete projetos (CV, demo,
// pesquisa, vitrine) não tentam faturar POR DECISÃO. Empurrá-los para uma das três inventaria um
// travamento que não existe — e "não vende de propósito" é um estado legítimo, não um defeito.
