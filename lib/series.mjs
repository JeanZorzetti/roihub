 ...
 * CTR agregado = cliques/impressões da janela (média dos CTRs diários mente igual).
 * @param {Map<string, Day>} byDate @param {string} start @param {string} end
 * @returns {{clicks:number, impressions:number, position:number|null, ctr:number|null}}
 */
 ...
 * @returns {{start:string, end:string, clicks:number, impressions:number, position:number|null, ctr:number|null}[]}
 */
