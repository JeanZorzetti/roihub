...
// XOR de tamanho fixo, sem node:crypto: o middleware importa este módulo e roda no
// Edge Runtime, que PROÍBE process.getBuiltinModule — nem sob optional chaining, porque
// a rejeição é da API em si, não do valor. Referenciá-la derrubava toda rota com 500.
