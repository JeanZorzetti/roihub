...
// CR₂ × … × ACV` e projeta receita a partir de benchmarks de terceiros. O handoff
// `handoff-a-okr-nao-falta-numero-falta-fator.md` mostra por que aquele número não vale aqui:
