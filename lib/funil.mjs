...
/** `rotuloBuraco` (018, FR-028) — opcional, e SEM default: gravar um valor em toda chamada não
 *  revisada produziria em massa a declaração falsa que esta spec existe para acabar. Ausente é
 *  byte a byte o comportamento de hoje — nunca `{naoApurado, rotuloBuraco: undefined}`.
 *  @param {string} motivo @param {"nao-mede"|"falhou-agora"|"tela-nao-le"} [rotuloBuraco]
 *  @returns {Celula} */
export const naoApurado = (motivo, rotuloBuraco) =>
  rotuloBuraco === undefined ? { naoApurado: motivo } : { naoApurado: motivo, rotuloBuraco };
