...
export function selo(chave) {
  ...
  if (r.tem) {
    ...
    // mesmo selo das outras cinco. A função também traz o piso de amostra, que não aparecia na tela.
