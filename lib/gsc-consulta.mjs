...
// 034 — `janela` opcional e com o default de sempre: o inventário de termos precisa de 8 meses, e
// os três chamadores anteriores continuam nos 28 dias sem mudar uma linha. Um quarto POST copiado
// para o script divergiria deste na primeira mudança de filtro.
export async function consultarGsc(host, dimensions = ["query", "page", "country"], janela = null) {
  ...
  const res = await client.request({
    ...
    method: "POST",
    data: {
      startDate: janela?.inicio ?? diasAtras(31),
      endDate: janela?.fim ?? diasAtras(3),
      dimensions,
      rowLimit: 25000,
