...
export function montarNiveis(entrada) {
  ...
  if (semPerfil) {
    ...
    n3 = nivel("N3", semEntrada("sem perfil declarado", "campo `perfil` do card"));
...
function montarN3(ficha) {
  ...
  return ficha.taxas.map((t) => {
    ...
    if (!ehApurado(t.celula)) return naoApurada(t.celula.naoApurado, rotulo, rotulo);
