...
export const REGUA = {
  ...
  //
  // `lead→respondeu`, `respondeu→orçamento` e `orçamento→tratamento` (a cadeia de hoje): sem linha
  // de propósito. Nenhum publica benchmark para esses degraus — são específicos de como a Atma
  // registra resposta e orçamento, não conceitos padronizados no mercado.
  D: {
