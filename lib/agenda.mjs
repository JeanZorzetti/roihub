...
/** Dono do card. A agenda não usa mais (ação do ranking não tem dono); os quadros usam. */
...
export function filtrosAtivos(f) {
  return ["q", "projeto", "tipo"].filter((k) => f[k]);
}
...
/** @param {{titulo:string, projeto:string, desc?:string|null, tipo:string}[]} items */
 ...
 */
export function acoesDoRanking(curados) {
