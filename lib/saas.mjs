 ...
 * deal criado 5 min ou mais depois da conta. Os contatos e deals de exemplo nascem no mesmo minuto
...
export function pagantes({ declarados, stripe, contasPorId, janela }) {
  ...
  // A cadeia divide pagantes por ativadas como se uma estivesse dentro da outra. Com ativação só por deal
  // (22/09/2026), uma pagante que usou só contatos (906, nenhum deal próprio) fica fora de "ativado": a
  // tela nomeia a conta em vez de deixar a taxa parecer subconjunto exato.
