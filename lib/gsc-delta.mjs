 ...
 * `Linha` de `Recusa`: sem eles, as 22 folhas sem veredito devolviam a MESMA frase por razões
...
const FPS = {
  fonte: "First Page Sage — meta-análise de CTR por posição",
  url: "https://firstpagesage.com/reports/google-click-through-rates-ctrs-by-ranking-position/",
  acessadoEm: ACESSO,
  recorte: "EUA · SERP limpa, sem outros elementos · sem segmentação por vertical · atualizado 2025-12-23",
};
...
export const MEDIDO_POR = {
  ...
  penetracaoTop3: "lib/kpis-busca.mjs#impressoesNoTop3",
...
/**
 * As 26 folhas do board `okr-Saw2eoSKZDPLJAk6xeDBuS`, na íntegra.
 *
...
export const CATALOGO = {
  ...
  ctrPorPosicao: {
    ...
    ramo: "clique",
    balizador: { tipo: "regua", ...FPS, media: null, elite: null, unidade: "ctr-por-posicao", base: "impressoes" },
  },
  penetracaoTop3: {
  ...
  ctrGap: {
    ...
    ramo: "ctr",
    balizador: { tipo: "regua", ...FPS, unidade: "cliques", base: "impressoes" },
  },
  conformidadeUrls: {
  ...
  larguraTitulo: {
    ...
    balizador: {
      tipo: "regua",
      fonte: "truncamento por largura em pixels, convergente entre fontes",
      url: "https://zyppy.com/seo/google-title-rewrite-study/",
      acessadoEm: ACESSO,
      recorte: "desktop · móvel comporta um pouco mais · piso de 500px do board é editorial, não tem fonte",
      limite: 580,
      unidade: "px",
    },
  },
 ...
 * entrava na tela como se fosse régua. O estudo mostrou que 21 das 26 folhas não são.
 *
