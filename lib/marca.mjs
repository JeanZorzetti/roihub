 ...
 * @returns {{ultima: SemanaNaoMarca, pico: SemanaNaoMarca, fracaoDoPico: number|null,
 *            quedasConsecutivas: number, semanasCompletas: number, parciaisIgnoradas: number} | null}
 */
